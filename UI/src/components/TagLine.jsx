  ...
  return (
    <div className="min-h-[20vh] px-5 flex justify-center items-center text-[#FFF8DB]">
        ...
        <div className=" text-3xl font-bold text-center leading-11">
            "Collecting 15 million Durood for the 1500<sup>th</sup> Milad of Prophet Muhammad (PBUH)"
        ...
        <div className="text-3xl font-bold text-center leading-12">
            "हमें पैग़ंबर मुहम्मद (सल्लल्लाहु अलैहि वसल्लम) के 1500<sup>वें</sup> मिलाद के लिए 1.5 करोड़ दरूद इकट्ठा करने हैं"
